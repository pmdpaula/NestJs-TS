...
import { RecipeItemDTO } from 'src/modules/recipe-item/dto/recipe-item.dto';
import { ClientDTO } from 'src/modules/client/dto/client.dto';
import { RecipeDTO } from 'src/modules/recipe/dto/recipe.dto';
import { EventTypeDTO } from 'src/modules/event-type/dto/event-type.dto';
import { ProjectDTO } from 'src/modules/project/dto/project.dto';
import { PaymentDTO } from 'src/modules/payment/dto/payment.dto';

// const categoryData: CategoryDTO = ;

export const categoriesData: CategoryDTO[] = [
  {
...
// Items
export const itemsData: ItemDTO[] = [
  {
...
// RecipeItems
export const recipeItemsData: RecipeItemDTO[] = [
  {
...
export const clientsData: ClientDTO[] = [
  {
...
export const recipesData: RecipeDTO[] = [
  {
...
export const eventTypesData: EventTypeDTO[] = [
  {
...
export const paymentsData: PaymentDTO[] = [
  {
